...
namespace LB.TweenHelper
{
    ...
    /// <summary>
    /// Internal factory for XY-plane orbit variants sharing the same DOTween-managed loop structure.
    /// </summary>
    ...
    /// <summary>
    /// Orbits the target counter-clockwise around its starting position on the XZ plane using a DOTween-managed loop.
    /// <para>
    ...
    /// <summary>
    /// Orbits the target clockwise around its starting position on the XZ plane using a DOTween-managed loop.
    /// <para>
    ...
    /// <summary>
    /// Orbits the target in a circle on the XY plane (2D-friendly) using a DOTween-managed loop.
    /// <para>
    ...
    /// <summary>
    /// Orbits the target clockwise on the XY plane using a DOTween-managed loop.
    /// <para>
    /// <b>Type:</b> Looping (DOTween-managed) | <b>Default duration:</b> 2.0s per revolution | <b>Default ease:</b> Linear<br/>
    /// <b>Easing override:</b> Primary ease controls angular progression.<br/>
    /// <b>Strength override:</b> Multiplies orbit radius (default 1.0).
    ...
    /// <summary>
    /// Orbits the target counter-clockwise on the XY plane using a DOTween-managed loop.
    /// <para>
    /// <b>Type:</b> Looping (DOTween-managed) | <b>Default duration:</b> 2.0s per revolution | <b>Default ease:</b> Linear<br/>
    /// <b>Easing override:</b> Primary ease controls angular progression.<br/>
    /// <b>Strength override:</b> Multiplies orbit radius (default 1.0).
    ...
    /// <summary>
    /// Internal factory for YZ-plane orbit variants sharing the same DOTween-managed loop structure.
    /// </summary>
    ...
    /// <summary>
    /// Orbits the target in a circle on the YZ plane using a DOTween-managed loop.
    /// <para>
    /// <b>Type:</b> Looping (DOTween-managed) | <b>Default duration:</b> 2.0s per revolution | <b>Default ease:</b> Linear<br/>
    /// <b>Easing override:</b> Primary ease controls angular progression.<br/>
    /// <b>Strength override:</b> Multiplies orbit radius (default 1.0).
    ...
    /// <summary>
    /// Orbits the target clockwise on the YZ plane using a DOTween-managed loop.
    /// <para>
    /// <b>Type:</b> Looping (DOTween-managed) | <b>Default duration:</b> 2.0s per revolution | <b>Default ease:</b> Linear<br/>
    /// <b>Strength override:</b> Multiplies orbit radius (default 1.0).
    /// </para>
    ...
    /// <summary>
    /// Orbits the target counter-clockwise on the YZ plane using a DOTween-managed loop.
    /// <para>
    /// <b>Type:</b> Looping (DOTween-managed) | <b>Default duration:</b> 2.0s per revolution | <b>Default ease:</b> Linear<br/>
    /// <b>Strength override:</b> Multiplies orbit radius (default 1.0).
    /// </para>
