...
namespace LB.TweenHelper
{
    ...
    /// <summary>
    /// Internal factory for alternating fade loop presets.
    /// </summary>
    internal static class LoopingFadeCycleFactory
    {
        public static Tween Create(GameObject target, float duration, TweenOptions options, float lowAlphaDefault, Ease defaultEase)
        {
            ...
            var fadeDown = CodePreset.CreateFadeTweenStatic(target, CodePreset.ResolveTargetAlphaStatic(options, lowAlphaDefault), halfDur);
            var fadeUp = CodePreset.CreateFadeTweenStatic(target, 1f, halfDur);
            if (fadeDown == null || fadeUp == null)
            {
                fadeDown?.Kill();
                fadeUp?.Kill();
                return null;
            ...
            return DOTween.Sequence()
                .Append(fadeDown.SetEase(fadeOutEase))
                .Append(fadeUp.SetEase(fadeInEase))
    ...
    /// Uses a repeating sequence so delay applies only on the first cycle.
    /// Supports CanvasGroup, SpriteRenderer, Image, Text, and Renderer materials.
    /// </para>
    /// <para>
    /// <b>Type:</b> Looping (sequence) | <b>Default duration:</b> 0.4s (0.2s per leg) | <b>Default ease:</b> InOutQuad<br/>
    ...
    /// <para>
    /// Same sequence loop pattern as Blink but with a longer cycle time.
    /// </para>
    /// <para>
    /// <b>Type:</b> Looping (sequence) | <b>Default duration:</b> 0.8s (0.4s per leg) | <b>Default ease:</b> InOutQuad<br/>
    /// <b>Easing override:</b> Primary ease controls fade-off; secondary ease controls fade-on.<br/>
    /// <b>Alpha override:</b> TargetAlpha replaces 0 (off alpha).<br/>
    /// <b>Requires:</b> A fadeable component.
    /// </para>
    ...
    /// <para>
    /// Same sequence loop pattern as Blink but with a shorter cycle time for a more urgent effect.
    /// </para>
    /// <para>
    /// <b>Type:</b> Looping (sequence) | <b>Default duration:</b> 0.2s (0.1s per leg) | <b>Default ease:</b> InOutQuad<br/>
    /// <b>Easing override:</b> Primary ease controls fade-off; secondary ease controls fade-on.<br/>
    /// <b>Alpha override:</b> TargetAlpha replaces 0 (off alpha).<br/>
    /// <b>Requires:</b> A fadeable component.
    /// </para>
    ...
    /// throughout. Uses a repeating sequence; delay applies only on the first cycle.
    /// </para>
    /// <para>
    /// <b>Type:</b> Looping (sequence) | <b>Default duration:</b> 2.0s (1.0s per leg) | <b>Default ease:</b> InOutSine<br/>
    ...
    /// <para>
    /// Same sequence loop pattern as PulseFade but with a longer cycle time and shallower
    /// fade depth for a more subtle breathing effect.
    /// </para>
    /// <para>
    /// <b>Type:</b> Looping (sequence) | <b>Default duration:</b> 3.0s (1.5s per leg) | <b>Default ease:</b> InOutSine<br/>
    /// <b>Easing override:</b> Primary ease controls fade-down; secondary ease controls fade-up.<br/>
    /// <b>Alpha override:</b> TargetAlpha replaces low-point alpha.<br/>
    /// <b>Requires:</b> A fadeable component.
    /// </para>
    ...
    /// <para>
    /// Same sequence loop pattern as PulseFade but with a shorter cycle time and deeper
    /// fade depth for a more intense, urgent effect.
    /// </para>
    /// <para>
    /// <b>Type:</b> Looping (sequence) | <b>Default duration:</b> 1.0s (0.5s per leg) | <b>Default ease:</b> InOutSine<br/>
    /// <b>Easing override:</b> Primary ease controls fade-down; secondary ease controls fade-up.<br/>
    /// <b>Alpha override:</b> TargetAlpha replaces low-point alpha.<br/>
    /// <b>Requires:</b> A fadeable component.
    /// </para>
