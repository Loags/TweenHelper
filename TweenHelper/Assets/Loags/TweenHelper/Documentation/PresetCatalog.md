...
The five staggered collection recipes compose these finite presets into group sequences and are intentionally not registry entries. See [Staggered collections](StaggeredCollections.md).

Generated by Tween Helper's internal release tooling. Generation fails on duplicate, empty, or unconstructible presets.
