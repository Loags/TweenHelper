...
The gallery is the package's single public demo. Its 415 entries provide mouse-driven access to:

- All 300 registered presets, with search and family filters.
- 13 semantic UI recipes.
- Nineteen collection and stagger examples.
...
The Editor Preset Browser is the broader component-preview surface. It contains 457 isolated entries, including fourteen progress-bar and nine engine-property examples that are intentionally not duplicated in this capture-focused gallery.
