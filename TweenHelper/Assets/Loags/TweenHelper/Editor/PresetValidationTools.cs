...
namespace LB.TweenHelper.Editor
{
    ...
    public static class PresetValidationTools
    {
        ...
        private static void LogValidationSummary(string kind, int presetCount, List<string> errors, List<string> warnings, IEnumerable<string> extraLines, bool showDialog)
        {
            ...
            if (showDialog) EditorUtility.DisplayDialog(title, message, "OK");
        }
    }
}
