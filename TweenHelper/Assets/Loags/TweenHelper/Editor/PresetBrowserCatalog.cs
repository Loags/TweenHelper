...
namespace LB.TweenHelper.Editor
{
    internal static class PresetBrowserCatalog
    {
        ...
        private static IEnumerable<PresetBrowserEntry> CreateTextEntries()
        {
            ...
            yield return Operation(PresetBrowserOperation.TextStaggerOut, "Staggers characters, words, or lines out of view.", category, family, "0.58s", "label.TextStaggerOut(TextAnimationUnit.Line, StaggerOrder.LastToFirst, unitStagger: 0.2f);", badge, preview, "Up");
