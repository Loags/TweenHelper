...
namespace LB.TweenHelper.Editor
{
    internal static class PresetBrowserCatalog
    {
        ...
        private static IEnumerable<PresetBrowserEntry> CreateTextEntries()
        {
            ...
            yield return Operation(PresetBrowserOperation.TextStaggerIn, "Staggers characters, words, or lines into place.", category, family, "0.65s", "label.TextStaggerIn(TextAnimationUnit.Word, StaggerOrder.FromCenter);", badge, preview, "Up");
            yield return Operation(PresetBrowserOperation.TextStaggerOut, "Staggers characters, words, or lines out of view.", category, family, "0.58s", "label.TextStaggerOut(TextAnimationUnit.Line, StaggerOrder.LastToFirst);", badge, preview, "Up");
