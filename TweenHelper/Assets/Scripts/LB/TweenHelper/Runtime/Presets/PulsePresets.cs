...
namespace LB.TweenHelper
{
    ...
    /// <b>Easing override:</b> Primary ease controls scale-up; secondary ease controls scale-down.
    /// </para>
    /// Usage: <c>transform.Tween().Preset("PulseScaleSmall").Play();</c>
    /// </summary>
    [AutoRegisterPreset]
    public class PulseScaleSmallPreset : CodePreset
    {
        public override string PresetName => "PulseScaleSmall";
    ...
    /// <b>Easing override:</b> Primary ease controls scale-up; secondary ease controls scale-down.
    /// </para>
    /// Usage: <c>transform.Tween().Preset("PulseScaleMedium").Play();</c>
    /// </summary>
    [AutoRegisterPreset]
    public class PulseScaleMediumPreset : CodePreset
    {
        public override string PresetName => "PulseScaleMedium";
    ...
    /// <b>Easing override:</b> Primary ease controls scale-up; secondary ease controls scale-down.
    /// </para>
    /// Usage: <c>transform.Tween().Preset("PulseScaleLarge").Play();</c>
    /// </summary>
    [AutoRegisterPreset]
    public class PulseScaleLargePreset : CodePreset
    {
        public override string PresetName => "PulseScaleLarge";
